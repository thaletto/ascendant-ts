...
type SourcePlanetName = (typeof BODY_ENTRIES)[number][0];

interface PlacementEvidence {
  readonly houses: Swisseph.HouseData;
  readonly planetEntries: readonly (readonly [SourcePlanetName, Swisseph.PlanetaryPosition])[];
}
...
const validateInput = Effect.fn("ChartService.validateInput")(function* (input: LocatedMoment) {
  const valid =
...
const normalizeDivisions = Effect.fn("ChartService.normalizeDivisions")(function* (
...
const placementsFromEvidence = Effect.fn("ChartService.placementsFromEvidence")(
...
const chartsFromPlacements = Effect.fn("ChartService.chartsFromPlacements")(
  function* (
    placements: Placements,
...
export function makeGenerate(ephemeris: Ephemeris["Service"], astroParams: AstroParams["Service"]) {
  const calculatePlacementEvidence = Effect.fn("ChartService.calculatePlacementEvidence")(
  ...
  return Effect.fn("ChartService.generate")(function* (
    input: LocatedMoment,
